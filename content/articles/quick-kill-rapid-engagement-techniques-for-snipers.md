...
That was the pinnacle of traditional sniping. One man, infinite patience, a hide position maintained for hours or days until the shot presented itself. The mythology of "One Shot One Kill" lingers above sniper schools worldwide. It makes for excellent recruitment posters.

It is also, according to N. in Light Fighter Manifesto Volume III, "the very first myth we should abolish from our minds."

---

## The Extinction Event

The sniper who low-crawls into a hide and waits for days still exists. He is just running out of battlefields where that approach works.
...
Ukrainian snipers around Bakhmut talk about positions occupied for minutes or hours, not days. Constant movement. Targets appearing on thermal feeds for seconds before vanishing behind walls or going underground. The tempo is closer to room clearing than traditional fieldcraft.
...
N. opened his piece with a vivid description of assault chaos: "One moment, Cell 1 is making entry and establishing an internal foothold; the next moment, a Toyota Corolla is hurtling through the foyer drywall from a QRF VBIED, GFC is down hard, and an 8-year-old is at the end of the hallway with an AR15."

Nothing in that scenario allows for careful stillness.

The second myth that needs to die: snipers have no place inside an assault element. The Sniper and Observation Team proves otherwise. SNOT maintains extended security during infiltration, giving leadership early warning of enemy presence. Prior to breach, SNOT observes the target structure for threats including IEDs. If immediate danger appears, SNOT either eliminates it instantly or aborts the breach over comms.

During the assault itself, SNOT engages point threats both internal and external to the structure. By shooting threats forward of the assaulters' front-line trace, SNOT reduces the risk of entering rooms with live enemies still inside. When threats attempt to exfil during the chaos, they run into SNOT's field of fire.

N. described the mechanics: "Typically SNOT will stay on the same floor and 1 room ahead of assaulters. Post assault and containment SNOT will invert their fields of fire, flipping 180 degrees to provide isolation for the element."

The sniper is not watching from a hilltop. The sniper is in the stack.
...
Thirty meters to five hundred. Not the thousand-yard shots of sniper mythology. Combat distances where the rifle is a precision instrument for problems too far for the assaulters and too close for traditional sniper employment.

The shorter barrels make sense in this context. Maneuverability through doorways. Faster target acquisition. The 16-inch .308 SR25 that N. described as his standard load is a compromise between terminal performance and the ability to actually move through a structure without hanging up on every corner.

---

## Speed Kills: Danger Space
...
Using an AB Kestrel and mission-specific data, the sniper compiles ballistic information before stepping off.
...
## Wind Width: Risk Assessment Under Fire

The traditional method for wind calls: read the vegetation, read the mirage, estimate velocity at the target, velocity at midrange, velocity at the muzzle, average them, multiply by your wind factor, apply the hold.
...
These techniques layer with SNOT doctrine.
...
None of this replaces fundamentals. Stable position. Clean trigger press. Calling the shot and knowing when you have missed. But the cognitive overhead compresses. The math, the lookups, the second-guessing. It becomes pattern recognition that runs without conscious processing.

N. described why caliber matters: "SNOT will generally shoot through windows, plexiglass, or auto glass; a higher caliber than 5.56 will make it more barrier-blind."

The .308 through the window at 80 meters hits exactly as intended. The 5.56 through the same window scatters fragments across the room and maybe hits something useful. Maybe not.

---

## Civilian Translation

N. posed a question worth considering: "How does this translate to civilian training?"

His answer: "Extending a fight from your family and your neighborhood during a natural disaster will lead to the preservation of life. Getting the fight over far before any threat can engage you is key."
...
By the time he reaches the window and finds something stable to shoot from, he will have maybe ten seconds to read the shot and take it. After that the target will be gone. There is no time to pull out a rangefinder. No time to reference the dope card. He sees what his reticle tells him and either presses the trigger or does not.
...
- Light Fighter Manifesto Volume III: "Sniping on the Assault" (N., 2023)

### Tools

- [Light Fighter Guide](/apps/field-guide/) - Marksmanship section with Wind Drift Calculator
