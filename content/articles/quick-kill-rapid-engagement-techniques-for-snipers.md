...
Volume III called it "the very first myth we should abolish from our minds."

---

## The Extinction Event

The sniper who low-crawls into a hide and waits for days still exists. He is running out of battlefields where that approach works.
...
Volume III opened with assault chaos. Cell 1 makes entry and establishes an internal foothold. Seconds later, a car bomb crashes through the foyer wall. The ground force commander is down. An 8-year-old stands at the end of the hallway with an AR15.
...
Designated marksmen carry weapons that use the same caliber and magazines as everyone else in the squad. They extend the squad's range. Riflemen with better glass.

Assault snipers carry sniper-specific weapons: "shorter 14.5" SR25s or Scar 17s to longer 20" SR25s, and all the way to magnum caliber bolt action rifles."

The caliber distinction matters because SNOT frequently shoots through barriers. Windows. Plexiglass. Auto glass. A 5.56 deflects. A .308 punches through.

"Over hundreds of different engagements, the average engagement for the assault sniper will occur between 30 m and 500 m."
